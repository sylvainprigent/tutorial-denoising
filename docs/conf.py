# -*- coding: utf-8 -*-
#
# napari-sdeconv documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'napari-cookiecutterplugin_name', u'napari-sdeconv Documentation',
     [author], 1)
]
